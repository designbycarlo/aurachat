#!/usr/bin/env node
/* Standalone migration runner — intended for a deploy `preDeployCommand`
 * (e.g. Render) and local use (`npm run migrate`).
 *
 ...
 * so it uses almost no memory — important on Render's free tier where RAM is
